...
class SecurityDocument {
  ...
  @override
  String toString() =>
      'SecurityDocument[id=$id, key=$key, metadata=$metadata, audit=$audit]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "SecurityDocument[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "SecurityDocument[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SecurityDocument> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SecurityDocument>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SecurityDocument.listFromJson(
          entry.value,
          growable: growable,
        );
      }
