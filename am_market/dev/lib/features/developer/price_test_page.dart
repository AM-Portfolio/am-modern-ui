  ...
  Future<void> _fetchPrice() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
            '${ApiService.baseUrl}/v1/market-data/quotes?symbols=$symbol&provider=$_provider&isIndex=$_isIndex&refresh=$forceRefresh'),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        setState(
            () => _error = "Status ${response.statusCode}: ${response.body}");
      }
    } catch (e) {
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                _kv(context, "Change", "${data['change']}",
                    color:
                        (data['change'] ?? 0) >= 0 ? Colors.green : Colors.red),
