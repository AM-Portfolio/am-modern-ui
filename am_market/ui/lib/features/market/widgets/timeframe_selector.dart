...
class TimeframeSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final row = Row(
      ...
      children: ['1D', '1W', '1M', '3M', '6M', '1Y', '5Y'].map((tf) {
        ...
        return _buildTimeframeButton(context, tf, isSelected);
      }).toList(),
    );
  ...
  Widget _buildTimeframeButton(BuildContext context, String tf, bool isSelected) {
      ...
      child: MouseRegion(
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedDefaultTextStyle(
            duration: const Duration(milliseconds: 150),
            style: TextStyle(
              color: isSelected ? const Color(0xFF000000) : MarketColors.tfPillDefaultText(context),
              fontSize: 12,
