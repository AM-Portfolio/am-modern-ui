...
class MonthlyPerformanceCard extends StatefulWidget {
  ...
  const MonthlyPerformanceCard(
      {Key? key, required this.data, this.isCompactTable = false})
      : super(key: key);
...
class _MonthlyPerformanceCardState extends State<MonthlyPerformanceCard> {
          ...
          child: InkWell(
            ...
            child: Container(
              padding: const EdgeInsets.symmetric(
                  horizontal: 8, vertical: 8), // More internal padding
                  ...
                  Expanded(
                    child: Text(
                      ...
                      overflow: TextOverflow
                          .visible, // Wrapping allowed if needed, but expanded width should help
                      maxLines: 1,
                    ),
                  ),
  ...
  Widget _buildCompactRow(
      BuildContext context, String label, IndexPerformance perf) {
      ...
      children: [
        ...
        SizedBox(
          ...
          child: Text(
            label,
            style: TextStyle(
                color: isDark ? Colors.white38 : Colors.black45, fontSize: 10),
          ),
        ),
        // Badge
        Expanded(
