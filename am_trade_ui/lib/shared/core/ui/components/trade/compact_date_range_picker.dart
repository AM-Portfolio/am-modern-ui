...
class _CompactDateRangePickerDialogState
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildShortcutItem("Last Week", () {
                    ...
                    final startLast =
                        startCurrent.subtract(const Duration(days: 7));
                  ...
                  _buildShortcutItem("Last Month", () {
                    ...
                    final lastOfPrev =
                        firstOfCurrent.subtract(const Duration(days: 1));
                    final firstOfPrev =
                              ...
                              ? () {
                                  ...
                                  if (end.isBefore(_startDate!)) {
                                    Navigator.of(context).pop(DateTimeRange(
                                        start: end, end: _startDate!));
                                  } else {
                                    Navigator.of(context).pop(DateTimeRange(
                                        start: _startDate!, end: end));
                                  }
                                }
                              : null,
        ...
        return InkWell(
          onTap: isFuture
              ...
              : () {
                  setState(() {
                    _displayedMonth =
                        DateTime(_displayedMonth.year, monthIndex);
                    _viewMode = _PickerView.calendar;
                  });
                },
          borderRadius: BorderRadius.circular(8),
  ...
  Widget _buildCalendarGrid(ThemeData theme) {
    ...
    return GridView.builder(
      physics: const NeverScrollableScrollPhysics(),
      padding: const EdgeInsets.symmetric(
          horizontal: 16), // minimal padding horizontal
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 7,
