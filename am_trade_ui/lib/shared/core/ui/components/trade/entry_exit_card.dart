...
class _EntryExitCardState extends State<EntryExitCard>
              ...
              children: [
                ...
                if (widget.showExit)
                  ...
                  _buildDisabledContent(
                      theme, 'Close the trade to add exit details'),
              ],
            ),
          ),
        ],
        ...
        child: Column(
          ...
          children: [
            ModernDateTimePicker(
                initialDateTime: widget.entryDate,
                onDateTimeChanged: widget.onEntryDateChanged),
  ...
  Widget _buildExitContent(ThemeData theme) => SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ModernDateTimePicker(
                initialDateTime: widget.exitDate,
                onDateTimeChanged: widget.onExitDateChanged),
