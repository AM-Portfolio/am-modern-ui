...
class TradeControllerMapper {
  ...
  static DerivativeInfo toDerivativeInfoEntity(DerivativeInfoDto dto) =>
      DerivativeInfo(
        derivativeType: dto.derivativeType,
        strikePrice: dto.strikePrice,
        expiryDate:
            dto.expiryDate != null ? DateTime.tryParse(dto.expiryDate!) : null,
        optionType: dto.optionType,
        underlyingSymbol: dto.underlyingSymbol,
      );

  static DerivativeInfoDto toDerivativeInfoDto(DerivativeInfo entity) =>
      DerivativeInfoDto(
  ...
  static InstrumentInfo toInstrumentInfoEntity(InstrumentInfoDto dto) =>
      InstrumentInfo(
        symbol: dto.symbol,
        isin: dto.isin,
        ...
        derivativeInfo: dto.derivativeInfo != null
            ? toDerivativeInfoEntity(dto.derivativeInfo!)
            : null,
  ...
  static InstrumentInfoDto toInstrumentInfoDto(InstrumentInfo entity) =>
      InstrumentInfoDto(
        ...
        derivativeInfo: entity.derivativeInfo != null
            ? toDerivativeInfoDto(entity.derivativeInfo!)
            : null,
  ...
  static EntryExitInfo toEntryExitInfoEntity(EntryExitInfoDto dto) =>
      EntryExitInfo(
        timestamp:
  ...
  static EntryExitInfoDto toEntryExitInfoDto(EntryExitInfo entity) =>
      EntryExitInfoDto(
  ...
  static TradeMetricsDto toTradeMetricsDto(TradeMetrics entity) =>
      TradeMetricsDto(
  ...
  static TradePsychologyData toTradePsychologyDataEntity(
          TradePsychologyDataDto dto) =>
      TradePsychologyData(
  ...
  static TradePsychologyDataDto toTradePsychologyDataDto(
          TradePsychologyData entity) =>
      TradePsychologyDataDto(
  ...
  static TradeEntryExitReasoning toTradeEntryExitReasoningEntity(
          TradeEntryExitReasoningDto dto) =>
  ...
  static TradeEntryExitReasoningDto toTradeEntryExitReasoningDto(
          TradeEntryExitReasoning entity) =>
  ...
  static ExecutionInfo toExecutionInfoEntity(ExecutionInfoDto dto) =>
      ExecutionInfo(
          quantity: dto.quantity, price: dto.price, orderType: dto.orderType);
  ...
  static TradeModel toTradeModelEntity(TradeModelDto dto) => TradeModel(
        basicInfo:
            dto.basicInfo != null ? toBasicInfoEntity(dto.basicInfo!) : null,
        instrumentInfo: dto.instrumentInfo != null
            ? toInstrumentInfoEntity(dto.instrumentInfo!)
            : null,
        executionInfo: dto.executionInfo != null
            ? toExecutionInfoEntity(dto.executionInfo!)
            : null,
        fnoInfo: dto.fnoInfo != null ? toFnOInfoEntity(dto.fnoInfo!) : null,
        charges: dto.charges != null ? toChargesEntity(dto.charges!) : null,
        financials:
            dto.financials != null ? toFinancialsEntity(dto.financials!) : null,
      );

  static TradeModelDto toTradeModelDto(TradeModel entity) => TradeModelDto(
        basicInfo:
            entity.basicInfo != null ? toBasicInfoDto(entity.basicInfo!) : null,
        instrumentInfo: entity.instrumentInfo != null
            ? toInstrumentInfoDto(entity.instrumentInfo!)
            : null,
        executionInfo: entity.executionInfo != null
            ? toExecutionInfoDto(entity.executionInfo!)
            : null,
        fnoInfo: entity.fnoInfo != null ? toFnOInfoDto(entity.fnoInfo!) : null,
        charges: entity.charges != null ? toChargesDto(entity.charges!) : null,
        financials: entity.financials != null
            ? toFinancialsDto(entity.financials!)
            : null,
      );
  ...
  static TradeDetails toTradeDetailsEntity(TradeDetailsDto dto) => TradeDetails(
        ...
        exitInfo:
            dto.exitInfo != null ? toEntryExitInfoEntity(dto.exitInfo!) : null,
        currentPrice: dto.currentPrice,
        metrics:
            dto.metrics != null ? toTradeMetricsEntity(dto.metrics!) : null,
        ...
        psychologyData: dto.psychologyData != null
            ? toTradePsychologyDataEntity(dto.psychologyData!)
            : null,
        entryReasoning: dto.entryReasoning != null
            ? toTradeEntryExitReasoningEntity(dto.entryReasoning!)
            : null,
        exitReasoning: dto.exitReasoning != null
            ? toTradeEntryExitReasoningEntity(dto.exitReasoning!)
            : null,
      );

  static TradeDetailsDto toTradeDetailsDto(TradeDetails entity) =>
      TradeDetailsDto(
        tradeId: entity.tradeId,
        ...
        exitInfo: entity.exitInfo != null
            ? toEntryExitInfoDto(entity.exitInfo!)
            : null,
        currentPrice: entity.currentPrice,
        metrics:
            entity.metrics != null ? toTradeMetricsDto(entity.metrics!) : null,
        ...
        psychologyData: entity.psychologyData != null
            ? toTradePsychologyDataDto(entity.psychologyData!)
            : null,
        entryReasoning: entity.entryReasoning != null
            ? toTradeEntryExitReasoningDto(entity.entryReasoning!)
            : null,
        exitReasoning: entity.exitReasoning != null
            ? toTradeEntryExitReasoningDto(entity.exitReasoning!)
            : null,
      );

  // FilterSummary mappings
  static FilterSummary toFilterSummaryEntity(FilterSummaryDto dto) =>
      FilterSummary(
  ...
  static FilterSummaryDto toFilterSummaryDto(FilterSummary entity) =>
      FilterSummaryDto(
  ...
  static FilterTradeDetailsResponse toFilterTradeDetailsResponseEntity(
          FilterTradeDetailsResponseDto dto) =>
      FilterTradeDetailsResponse(
        trades: dto.trades?.map(toTradeDetailsEntity).toList(),
        totalCount: dto.totalCount,
        appliedFilterName: dto.appliedFilterName,
        filterSummary: dto.filterSummary != null
            ? toFilterSummaryEntity(dto.filterSummary!)
            : null,
        page: dto.page,
        size: dto.size,
  ...
  static FilterTradeDetailsResponseDto toFilterTradeDetailsResponseDto(
          FilterTradeDetailsResponse entity) =>
      FilterTradeDetailsResponseDto(
        ...
        filterSummary: entity.filterSummary != null
            ? toFilterSummaryDto(entity.filterSummary!)
            : null,
        page: entity.page,
        size: entity.size,
  ...
  static PaginatedTradeResponse toPaginatedTradeResponseEntity(
          PaginatedTradeResponseDto dto) =>
  ...
  static PaginatedTradeResponseDto toPaginatedTradeResponseDto(
          PaginatedTradeResponse entity) =>
  ...
  static ErrorResponse toErrorResponseEntity(ErrorResponseDto dto) =>
      ErrorResponse(
        timestamp:
            dto.timestamp != null ? DateTime.tryParse(dto.timestamp!) : null,
        status: dto.status,
  ...
  static ErrorResponseDto toErrorResponseDto(ErrorResponse entity) =>
      ErrorResponseDto(
        timestamp: entity.timestamp?.toIso8601String(),
        status: entity.status,
        error: entity.error,
