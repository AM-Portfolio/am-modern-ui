...
abstract class NotebookRemoteDataSource {
  ...
  Future<List<NotebookItemDto>> getNotebookItems(
      {String? parentId, NotebookItemType? type});
  Future<NotebookItemDto> getNotebookItem(String itemId);
  Future<NotebookItemDto> updateNotebookItem(
      String itemId, NotebookItemDto request);
  ...
  Future<NotebookTagDto> updateNotebookTag(
      String tagId, NotebookTagDto request);
...
class NotebookRemoteDataSourceImpl implements NotebookRemoteDataSource {
  ...
  Future<NotebookItemDto> createNotebookItem(NotebookItemDto request) async {
    ...
    try {
      ...
      final response = await _apiClient.post<NotebookItemDto>(
        ...
        parser: (data) =>
            NotebookItemDto.fromJson(data! as Map<String, dynamic>),
      );
      AppLogger.info('Notebook item created successfully',
          tag: 'NotebookRemoteDataSource');
      AppLogger.methodExit('createNotebookItem',
          tag: 'NotebookRemoteDataSource', result: 'success');
      return response;
    } catch (e) {
      AppLogger.error(
  ...
  @override
  Future<List<NotebookItemDto>> getNotebookItems(
      {String? parentId, NotebookItemType? type}) async {
    AppLogger.methodEntry(
      'getNotebookItems',
      tag: 'NotebookRemoteDataSource',
    ...
    try {
      ...
      if (type != null)
        queryParts.add('type=${type.toString().split('.').last}');

      final baseUri = _buildUri(_tradeConfig.baseUrl, 'v1/notebook/items');
      final fullUri =
          queryParts.isEmpty ? baseUri : '$baseUri?${queryParts.join('&')}';
      ...
      final response = await _apiClient.get<List<NotebookItemDto>>(
        ...
        parser: (data) {
          if (data is List) {
            return data
                .map((item) =>
                    NotebookItemDto.fromJson(item as Map<String, dynamic>))
                .toList();
          }
          return [];
        },
      );
      AppLogger.info('Notebook items fetched successfully',
          tag: 'NotebookRemoteDataSource');
      AppLogger.methodExit('getNotebookItems',
          tag: 'NotebookRemoteDataSource', result: 'success');
      return response;
    } catch (e) {
      AppLogger.error(
  ...
  Future<NotebookItemDto> getNotebookItem(String itemId) async {
    AppLogger.methodEntry('getNotebookItem',
        tag: 'NotebookRemoteDataSource', params: {'itemId': itemId});
    ...
    try {
      ...
      AppLogger.info('Notebook item fetched successfully',
          tag: 'NotebookRemoteDataSource');
      AppLogger.methodExit('getNotebookItem',
          tag: 'NotebookRemoteDataSource', result: 'success');
      return response;
    } catch (e) {
      AppLogger.error(
  ...
  @override
  Future<NotebookItemDto> updateNotebookItem(
      String itemId, NotebookItemDto request) async {
    AppLogger.methodEntry('updateNotebookItem',
        tag: 'NotebookRemoteDataSource', params: {'itemId': itemId});
    ...
    try {
      ...
      AppLogger.info('Notebook item updated successfully',
          tag: 'NotebookRemoteDataSource');
      AppLogger.methodExit('updateNotebookItem',
          tag: 'NotebookRemoteDataSource', result: 'success');
      return response;
    } catch (e) {
      AppLogger.error(
  ...
  Future<void> deleteNotebookItem(String itemId) async {
    AppLogger.methodEntry('deleteNotebookItem',
        tag: 'NotebookRemoteDataSource', params: {'itemId': itemId});
    ...
    try {
      ...
      AppLogger.info('Notebook item deleted successfully',
          tag: 'NotebookRemoteDataSource');
      AppLogger.methodExit('deleteNotebookItem',
          tag: 'NotebookRemoteDataSource', result: 'success');
    } catch (e) {
      AppLogger.error(
  ...
  Future<NotebookTagDto> createNotebookTag(NotebookTagDto request) async {
    ...
    try {
      ...
      final response = await _apiClient.post<NotebookTagDto>(
        ...
        body: tradeRequestBodyWithoutUserId(request.toJson()),
        parser: (data) =>
            NotebookTagDto.fromJson(data! as Map<String, dynamic>),
      );
      AppLogger.info('Notebook tag created successfully',
          tag: 'NotebookRemoteDataSource');
      AppLogger.methodExit('createNotebookTag',
          tag: 'NotebookRemoteDataSource', result: 'success');
      return response;
    } catch (e) {
      AppLogger.error(
  ...
  Future<List<NotebookTagDto>> getNotebookTags() async {
    AppLogger.methodEntry('getNotebookTags',
        tag: 'NotebookRemoteDataSource', params: {});
      ...
      final response = await _apiClient.get<List<NotebookTagDto>>(
        ...
        parser: (data) {
          if (data is List) {
            return data
                .map((item) =>
                    NotebookTagDto.fromJson(item as Map<String, dynamic>))
                .toList();
          }
          return [];
        },
      );
      AppLogger.info('Notebook tags fetched successfully',
          tag: 'NotebookRemoteDataSource');
      AppLogger.methodExit('getNotebookTags',
          tag: 'NotebookRemoteDataSource', result: 'success');
      return response;
    } catch (e) {
      AppLogger.error(
  ...
  @override
  Future<NotebookTagDto> updateNotebookTag(
      String tagId, NotebookTagDto request) async {
    AppLogger.methodEntry('updateNotebookTag',
        tag: 'NotebookRemoteDataSource', params: {'tagId': tagId});
    ...
    try {
      ...
      AppLogger.info('Notebook tag updated successfully',
          tag: 'NotebookRemoteDataSource');
      AppLogger.methodExit('updateNotebookTag',
          tag: 'NotebookRemoteDataSource', result: 'success');
      return response;
    } catch (e) {
      AppLogger.error(
  ...
  Future<void> deleteNotebookTag(String tagId) async {
    AppLogger.methodEntry('deleteNotebookTag',
        tag: 'NotebookRemoteDataSource', params: {'tagId': tagId});
    ...
    try {
      ...
      await _apiClient.delete<void>(fullUri, parser: (_) {});
      AppLogger.info('Notebook tag deleted successfully',
          tag: 'NotebookRemoteDataSource');
      AppLogger.methodExit('deleteNotebookTag',
          tag: 'NotebookRemoteDataSource', result: 'success');
    } catch (e) {
      AppLogger.error(
