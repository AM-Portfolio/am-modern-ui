...
class GetTradesByPortfolio {
  ...
  Future<List<TradeDetails>> call({
    ...
    try {
      AppLogger.info('Executing get trades by portfolio use case',
          tag: 'GetTradesByPortfolio');
      ...
      AppLogger.methodExit('GetTradesByPortfolio.call',
          tag: 'GetTradesByPortfolio', result: 'success');
      ...
      AppLogger.methodExit('GetTradesByPortfolio.call',
          tag: 'GetTradesByPortfolio', result: 'error');
      rethrow;
    }
  }
