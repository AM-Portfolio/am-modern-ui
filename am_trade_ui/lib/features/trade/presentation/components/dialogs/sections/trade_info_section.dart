...
class TradeInfoSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (holding.isDerivative) ...[
              _buildDerivativeInfoCard(context),
              const SizedBox(height: 16)
            ],
            ...
            // Entry Reasoning
            if (holding.hasEntryReasoning) ...[
              _buildEntryReasoningCard(context),
              const SizedBox(height: 16)
            ],

            // Exit Reasoning
            if (holding.hasExitReasoning) ...[
              _buildExitReasoningCard(context),
              const SizedBox(height: 16)
            ],

            // Psychology Data
            if (holding.hasPsychologyData) ...[
  ...
  Widget _buildCompanyInfoCard(BuildContext context) => InfoCard(
        ...
        children: [
          ...
          if (holding.isin != null)
            InfoRow(label: 'ISIN', value: holding.isin!),
          if (holding.currency != null)
            InfoRow(label: 'Currency', value: holding.displayCurrency),
          if (holding.lotSize != null)
            InfoRow(label: 'Lot Size', value: holding.displayLotSize),
        ],
      );
  ...
  Widget _buildDerivativeInfoCard(BuildContext context) => InfoCard(
        ...
        children: [
          ...
          if (holding.underlyingSymbol != null)
            InfoRow(
                label: 'Underlying', value: holding.displayUnderlyingSymbol),
          if (holding.strikePrice != null)
            InfoRow(label: 'Strike Price', value: holding.displayStrikePrice),
          if (holding.expiryDate != null)
            InfoRow(label: 'Expiry Date', value: holding.displayExpiryDate),
          if (holding.optionType != null)
            InfoRow(label: 'Option Type', value: holding.displayOptionType),
        ],
      );
  ...
  Widget _buildTradeDetailsCard(BuildContext context) => InfoCard(
        ...
        children: [
          ...
          InfoRow(
              label: 'Position Type',
              value: (holding.tradePositionType ?? 'Unknown').toUpperCase(),
              isBold: true),
          ...
          if (holding.broker != null)
            InfoRow(label: 'Broker', value: holding.broker!),
        ],
      );
  ...
  Widget _buildStrategyNotesCard(BuildContext context) => InfoCard(
        ...
        children: [
          if (holding.strategy != null)
            InfoRow(
                label: 'Strategy',
                value: holding.displayStrategy,
                isBold: true),
          if (holding.notes != null)
            InfoRow(
                label: 'Notes', value: holding.displayNotes, maxLines: null),
        ],
      );
  ...
  Widget _buildPricingCard(BuildContext context) => InfoCard(
        ...
        children: [
          ...
          if (holding.exitPrice != null)
            InfoRow(label: 'Exit Price', value: holding.displayExitPrice),
          ...
          if (holding.entryTotalValue != null)
            InfoRow(
                label: 'Entry Total Value',
                value: '\$${holding.entryTotalValue!.toStringAsFixed(2)}'),
          if (holding.exitTotalValue != null)
            InfoRow(
                label: 'Exit Total Value',
                value: '\$${holding.exitTotalValue!.toStringAsFixed(2)}'),
  ...
  Widget _buildFeesCard(BuildContext context) => InfoCard(
        ...
        children: [
          if (holding.entryFees != null)
            InfoRow(label: 'Entry Fees', value: holding.displayEntryFees),
          if (holding.exitFees != null)
            InfoRow(label: 'Exit Fees', value: holding.displayExitFees),
          const Divider(height: 16),
          InfoRow(
              label: 'Total Fees',
              value: holding.displayTotalFees,
              isBold: true),
        ],
      );
  ...
  Widget _buildPerformanceMetricsCard(BuildContext context) => InfoCard(
        ...
        children: [
          InfoRow(
            label: 'Profit/Loss',
            value:
                '${holding.displayProfitLoss} (${holding.displayProfitLossPercentage})',
            valueColor: holding.isProfit ? Colors.green : Colors.red,
            isBold: true,
          ),
          const Divider(height: 16),
          if (holding.returnOnEquity != null)
            InfoRow(
                label: 'Return on Equity',
                value: holding.displayReturnOnEquity),
          if (holding.riskAmount != null)
            InfoRow(label: 'Risk Amount', value: holding.displayRiskAmount),
          if (holding.rewardAmount != null)
            InfoRow(label: 'Reward Amount', value: holding.displayRewardAmount),
          ...
          if (holding.maxAdverseExcursion != null)
            InfoRow(
                ...
                value: holding.displayMaxAdverseExcursion,
        ...
        children: [
          if (holding.entryReasoning!.primaryReason != null)
            InfoRow(
                ...
                value: holding.entryReasoning!.primaryReason!,
                isBold: true),
          if (holding.entryReasoning!.reasoningSummary != null)
            InfoRow(
                label: 'Summary',
                value: holding.entryReasoning!.reasoningSummary!,
                maxLines: null),
          if (holding.entryReasoning!.confidenceLevel != null)
            InfoRow(
              ...
              valueColor:
                  _getConfidenceColor(holding.entryReasoning!.confidenceLevel!),
            ),
          if (holding.entryReasoning!.technicalReasons != null &&
              holding.entryReasoning!.technicalReasons!.isNotEmpty)
            InfoRow(
              label: 'Technical Reasons',
              value: holding.entryReasoning!.technicalReasons!
                  .map((e) => e.name)
                  .join(', '),
            ),
          if (holding.entryReasoning!.fundamentalReasons != null &&
              holding.entryReasoning!.fundamentalReasons!.isNotEmpty)
            InfoRow(
              label: 'Fundamental Reasons',
              value: holding.entryReasoning!.fundamentalReasons!
                  .map((e) => e.name)
                  .join(', '),
            ),
          if (holding.entryReasoning!.supportingIndicators != null &&
            ...
            InfoRow(
                ...
                value:
                    holding.entryReasoning!.supportingIndicators!.join(', ')),
  ...
  Widget _buildExitReasoningCard(BuildContext context) => InfoCard(
        ...
        children: [
          if (holding.exitReasoning!.exitPrimaryReason != null)
            InfoRow(
                label: 'Primary Reason',
                value: holding.exitReasoning!.exitPrimaryReason!,
                isBold: true),
          if (holding.exitReasoning!.exitReasoningSummary != null)
            InfoRow(
                label: 'Summary',
                value: holding.exitReasoning!.exitReasoningSummary!,
                maxLines: null),
          if (holding.exitReasoning!.exitConfidenceLevel != null)
            InfoRow(
              ...
              valueColor: _getConfidenceColor(
                  holding.exitReasoning!.exitConfidenceLevel!),
            ),
          if (holding.exitReasoning!.exitQualityScore != null)
            InfoRow(
              ...
              valueColor:
                  _getConfidenceColor(holding.exitReasoning!.exitQualityScore!),
              isBold: true,
            ),
          if (holding.exitReasoning!.exitSupportingIndicators != null &&
            ...
            InfoRow(
                label: 'Supporting Indicators',
                value: holding.exitReasoning!.exitSupportingIndicators!
                    .join(', ')),
        ],
      );
  ...
  Widget _buildPsychologyCard(BuildContext context) => InfoCard(
        ...
        children: [
          if (holding.psychologyData!.psychologyNotes != null)
            InfoRow(
                label: 'Notes',
                value: holding.psychologyData!.psychologyNotes!,
                maxLines: null),
          if (holding.psychologyData!.entryPsychologyFactors != null &&
            ...
            InfoRow(
              ...
              value: holding.psychologyData!.entryPsychologyFactors!
                  .map((e) => e.name)
                  .join(', '),
            ),
          if (holding.psychologyData!.exitPsychologyFactors != null &&
            ...
            InfoRow(
              ...
              value: holding.psychologyData!.exitPsychologyFactors!
                  .map((e) => e.name)
                  .join(', '),
            ),
          if (holding.psychologyData!.behaviorPatterns != null &&
              holding.psychologyData!.behaviorPatterns!.isNotEmpty)
            InfoRow(
              label: 'Behavior Patterns',
              value: holding.psychologyData!.behaviorPatterns!
                  .map((e) => e.name)
                  .join(', '),
            ),
        ],
