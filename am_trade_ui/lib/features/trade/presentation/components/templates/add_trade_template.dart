...
class _AddTradeTemplateState extends State<AddTradeTemplate> {
  ...
  TradeDetails _buildTradeDetails() {
    final instrumentInfo = InstrumentInfo(
      ...
      derivativeInfo: _selectedDerivativeType != null
          ? DerivativeInfo(
              ...
              strikePrice: _strikePriceController.text.isEmpty
                  ? null
    ...
    final psychologyData = TradePsychologyData(
      entryPsychologyFactors:
          _selectedEntryPsychology.isEmpty ? null : _selectedEntryPsychology,
      exitPsychologyFactors:
          _selectedExitPsychology.isEmpty ? null : _selectedExitPsychology,
      behaviorPatterns:
          _selectedBehaviorPatterns.isEmpty ? null : _selectedBehaviorPatterns,
      psychologyNotes: _psychologyNotesController.text.trim().isEmpty
          ? null
          : _psychologyNotesController.text.trim(),
    );

    final reasoning = TradeEntryExitReasoning(
      technicalReasons:
          _selectedTechnicalReasons.isEmpty ? null : _selectedTechnicalReasons,
      fundamentalReasons: _selectedFundamentalReasons.isEmpty
          ? null
  ...
  Widget _buildInstrumentStep(ThemeData theme, bool isDesktop, bool isTablet) =>
      SingleChildScrollView(
        ...
        child: _buildResponsiveCard(
          ...
          child: Column(
            ...
            children: [
              _buildSectionHeader(
                  theme, 'Instrument Information', Icons.assessment),
              ...
              _buildResponsiveGrid(
                ...
                children: [
                  _buildTextField(
                    ...
                    validator: (value) =>
                        value?.isEmpty ?? true ? 'Symbol is required' : null,
                  ),
                  _buildTextField(
  ...
  Widget _buildEntryDetailsStep(
          ThemeData theme, bool isDesktop, bool isTablet) =>
      SingleChildScrollView(
        padding: EdgeInsets.all(isDesktop ? 24 : 16),
        child: _buildResponsiveCard(
          theme,
  ...
  Widget _buildPsychologyStep(ThemeData theme, bool isDesktop, bool isTablet) =>
      SingleChildScrollView(
        padding: EdgeInsets.all(isDesktop ? 24 : 16),
        child: _buildResponsiveCard(
          theme,
          ...
          child: Column(
            ...
            children: [
              _buildSectionHeader(
                  theme, 'Psychology & Behavior', Icons.psychology_outlined),
              const SizedBox(height: 24),
              ...
              _buildTextField(
                ...
                hint:
                    'Describe your mental state, emotions, and thought process',
                icon: Icons.notes,
                maxLines: 5,
              ),
            ],
  ...
  Widget _buildReasoningStep(ThemeData theme, bool isDesktop, bool isTablet) =>
      SingleChildScrollView(
        padding: EdgeInsets.all(isDesktop ? 24 : 16),
        child: _buildResponsiveCard(
          theme,
          ...
          child: Column(
            ...
            children: [
              _buildSectionHeader(
                  theme, 'Trade Reasoning', Icons.lightbulb_outline),
              const SizedBox(height: 24),
  ...
  Widget _buildReviewStep(ThemeData theme, bool isDesktop, bool isTablet) =>
      SingleChildScrollView(
        padding: EdgeInsets.all(isDesktop ? 24 : 16),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
            ...
            if (isDesktop)
                    ...
                    child: Column(
                      children: [
                        _buildModernReviewCard(
                            theme, 'Instrument Details', Icons.assessment, [
                          _buildDetailRow(theme, 'Symbol',
                              _symbolController.text, Icons.local_offer),
                          if (_isinController.text.isNotEmpty)
                            _buildDetailRow(theme, 'ISIN', _isinController.text,
                                Icons.fingerprint),
                          ...
                          if (_descriptionController.text.isNotEmpty)
                            _buildDetailRow(theme, 'Description',
                                _descriptionController.text, Icons.description),
                        ]),
                        if (_selectedDerivativeType != null) ...[
                          const SizedBox(height: 16),
                          _buildModernReviewCard(
                              theme, 'Derivative Info', Icons.analytics, [
                            _buildDetailRow(
                              theme,
                              'Type',
                            ...
                            if (_strikePriceController.text.isNotEmpty)
                              _buildDetailRow(theme, 'Strike Price',
                                  _strikePriceController.text, Icons.gavel),
                        ...
                        const SizedBox(height: 16),
                        _buildModernReviewCard(
                            theme, 'Entry Details', Icons.login, [
                          _buildDetailRow(
                            theme,
                            'Direction',
                            _selectedDirection
                          ...
                          _buildDetailRow(theme, 'Quantity',
                              _entryQuantityController.text, Icons.tag),
                          ...
                          if (_strategyController.text.isNotEmpty)
                            _buildDetailRow(theme, 'Strategy',
                                _strategyController.text, Icons.psychology),
                        ]),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      children: [
                        if (_selectedStatus != TradeStatuses.open &&
                            _exitDate != null)
                          _buildModernReviewCard(
                              theme, 'Exit Details', Icons.logout, [
                            if (_exitDate != null)
                              _buildDetailRow(
                                theme,
                                'Exit Date',
                            ...
                            if (_exitQuantityController.text.isNotEmpty)
                              _buildDetailRow(theme, 'Exit Quantity',
                                  _exitQuantityController.text, Icons.tag),
                          ]),
                        if (_selectedStatus != TradeStatuses.open &&
                            _exitDate != null)
                          const SizedBox(height: 16),
                        if (_selectedEntryPsychology.isNotEmpty ||
                          ...
                          _buildModernReviewCard(theme, 'Psychology & Behavior',
                            ...
                            if (_psychologyNotesController.text.isNotEmpty)
                              _buildDetailRow(theme, 'Psychology Notes',
                                  _psychologyNotesController.text, Icons.notes),
                          ]),
                        if (_selectedEntryPsychology.isNotEmpty ||
                            _selectedExitPsychology.isNotEmpty ||
                            _selectedBehaviorPatterns.isNotEmpty)
                        ...
                        if (_selectedTechnicalReasons.isNotEmpty ||
                            _selectedFundamentalReasons.isNotEmpty)
                          _buildModernReviewCard(theme, 'Trade Reasoning',
              ...
              Column(
                children: [
                  _buildModernReviewCard(
                      theme, 'Instrument Details', Icons.assessment, [
                    _buildDetailRow(theme, 'Symbol', _symbolController.text,
                        Icons.local_offer),
                    if (_isinController.text.isNotEmpty)
                      _buildDetailRow(theme, 'ISIN', _isinController.text,
                          Icons.fingerprint),
                  ...
                  _buildModernReviewCard(theme, 'Entry Details', Icons.login, [
                    ...
                    if (_entryDate != null)
                      _buildDetailRow(
                          ...
                          _entryDate!.toLocal().toString().split(' ')[0],
                          Icons.event),
                    _buildDetailRow(theme, 'Entry Price',
                        '₹${_entryPriceController.text}', Icons.currency_rupee),
                    _buildDetailRow(theme, 'Quantity',
                        _entryQuantityController.text, Icons.tag),
                    if (_selectedBroker != null)
                      _buildDetailRow(
  ...
  Widget _buildResponsiveCard(ThemeData theme, bool isDesktop,
  ...
  Widget _buildResponsiveGrid(bool isDesktop, bool isTablet,
  ...
  Widget _buildDropdownField<T>({
    ...
    required String Function(T) itemBuilder,
      ...
      DropdownButtonFormField<T>(
        ...
        items: items
            .map((item) =>
                DropdownMenuItem(value: item, child: Text(itemBuilder(item))))
            .toList(),
        onChanged: onChanged,
      );
  ...
  Widget _buildModernReviewCard(ThemeData theme, String title, IconData icon,
  ...
  Widget _buildChipDetailRow(
          ThemeData theme, String label, List<String> items) =>
      Padding(
        padding: const EdgeInsets.only(bottom: 12),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
