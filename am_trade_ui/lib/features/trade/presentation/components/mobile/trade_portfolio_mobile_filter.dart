...
class TradePortfolioMobileFilter extends StatefulWidget {
  ...
  @override
  State<TradePortfolioMobileFilter> createState() =>
      _TradePortfolioMobileFilterState();
}

class _TradePortfolioMobileFilterState
    extends State<TradePortfolioMobileFilter> {
                    ...
                    Row(
                      children: [
                        ...
                        Material(
                          ...
                          child: InkWell(
                            onTap: () => widget
                                .onProfitFilterChanged(!widget.showOnlyProfit),
                            borderRadius: BorderRadius.circular(8),
                            child: Container(
                              padding: const EdgeInsets.symmetric(
