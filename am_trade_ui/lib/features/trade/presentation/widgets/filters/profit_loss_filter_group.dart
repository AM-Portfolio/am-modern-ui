...
class ProfitLossFilterGroup extends FilterGroup {
  ...
  final TextEditingController minPositionSizeController =
      TextEditingController();
  final TextEditingController maxPositionSizeController =
      TextEditingController();
  ...
  ProfitLossFilter toFilterCriteria() => ProfitLossFilter(
        minProfitLoss: minPnLController.text.isEmpty
            ? null
            : double.tryParse(minPnLController.text),
        maxProfitLoss: maxPnLController.text.isEmpty
            ? null
            : double.tryParse(maxPnLController.text),
        minPositionSize: minPositionSizeController.text.isEmpty
            ? null
            : double.tryParse(minPositionSizeController.text),
        maxPositionSize: maxPositionSizeController.text.isEmpty
            ? null
            : double.tryParse(maxPositionSizeController.text),
      );
