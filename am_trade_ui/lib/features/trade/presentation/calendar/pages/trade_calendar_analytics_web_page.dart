...
class _TradeCalendarAnalyticsWebPageState
  ...
  void _onDateSelectionChanged(
      DateSelection selection, TradeCalendarCubit cubit) {
    ...
    cubit.applyDateFilter(
        portfolioId: widget.portfolioId, dateSelection: selection);
  ...
  Widget build(BuildContext context) {
    final portfolioId = widget.portfolioId;
    final cubitAsync =
        ref.watch(tradeCalendarCubitProvider(widget.portfolioId));
      ...
      data: (cubit) => Scaffold(
        ...
        body: BlocBuilder<TradeCalendarCubit, TradeCalendarState>(
          ...
          builder: (context, state) => switch (state) {
            TradeCalendarLoading() =>
              _buildLoadingState(context, state.isRefresh),
            TradeCalendarLoaded() =>
              _buildMainContent(context, state.viewModel, cubit),
            TradeCalendarError() =>
              _buildErrorState(context, cubit, state.message),
            TradeCalendarFiltering() =>
              _buildFilteringState(context, state.currentData.viewModel, cubit),
            TradeCalendarRefreshing() => _buildRefreshingState(
                context, state.currentData.viewModel, cubit),
  ...
  PreferredSizeWidget _buildAppBar(
          BuildContext context, TradeCalendarCubit cubit) =>
      AppBar(
  ...
  Widget _buildMainContent(BuildContext context,
      TradeCalendarViewModel viewModel, TradeCalendarCubit cubit) {
  ...
  Widget _buildFilteringState(BuildContext context,
          TradeCalendarViewModel viewModel, TradeCalendarCubit cubit) =>
      Stack(
        children: [
  ...
  Widget _buildRefreshingState(BuildContext context,
          TradeCalendarViewModel viewModel, TradeCalendarCubit cubit) =>
      Stack(
        children: [
          _buildMainContent(context, viewModel, cubit),
  ...
  Widget _buildErrorState(
          BuildContext context, TradeCalendarCubit cubit, String message) =>
      Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
