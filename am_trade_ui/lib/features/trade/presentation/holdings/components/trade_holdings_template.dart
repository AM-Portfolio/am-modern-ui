...
class _TradeHoldingsTemplateState extends State<TradeHoldingsTemplate> {
  ...
  List<TradeHoldingViewModel> get _paginatedHoldings {
    ...
    final endIndex =
        (startIndex + widget.itemsPerPage).clamp(0, _sortedHoldings.length);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        // Main content
        Expanded(
            child: widget.isWebView ? _buildTableView() : _buildCardView()),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color:
                      isCurrentPage ? theme.primaryColor : Colors.transparent,
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(
                      color: isCurrentPage
                          ? theme.primaryColor
        ...
        child: SingleChildScrollView(
          child: DataTable(
            ...
            columns: [
              ...
              DataColumn(
                  label: const Text('Quantity'), numeric: true, onSort: _sort),
              DataColumn(
              ...
              DataColumn(
                  ...
                  onSort: _sort),
              DataColumn(
                  label: const Text('P&L'), numeric: true, onSort: _sort),
              DataColumn(
                  label: const Text('P&L %'), numeric: true, onSort: _sort),
              DataColumn(
                  label: const Text('R:R Ratio'), numeric: true, onSort: _sort),
            ],
            rows: _paginatedHoldings.map((holding) {
              ...
              return DataRow(
                cells: [
                  DataCell(Text(holding.displaySymbol,
                ...
                onSelectChanged: widget.onHoldingSelected != null
                    ? (_) => widget.onHoldingSelected!(holding)
                    : null,
              );
            }).toList(),
          ),
                        ...
                        Wrap(
                          ...
                          children: [
                            if (holding.sector != null)
                              _buildChip(holding.displaySector, Icons.category,
                                  Colors.blue),
                            if (holding.broker != null)
                              _buildChip(holding.broker!, Icons.account_balance,
                                  Colors.green),
