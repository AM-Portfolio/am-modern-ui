...
class DashboardSummaryWidget extends StatelessWidget {
  ...
  Widget _buildPortfolioCard(BuildContext context, bool isMobile) {
    ...
    final onSurface = isDark ? context.textPrimary : AppColors.textPrimaryDark;
    final onSurfaceVariant =
        isDark ? context.textSecondary : AppColors.textSecondaryDark;
            ...
            Text(
              ...
              style: TextStyle(
                color: AppColors.profitLossColor(
                  summary.dayChangePercentage.toDouble(),
                ),
                fontSize: 12,
                fontWeight: FontWeight.w600,
                fontFamily: 'Inter',
  ...
  Widget _buildReturnCard(BuildContext context) {
    ...
    final valueColor = AppColors.profitLossColor(summary.totalGainLoss);
