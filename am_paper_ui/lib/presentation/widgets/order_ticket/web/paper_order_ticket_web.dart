...
class PaperOrderTicketWeb extends StatelessWidget {
  const PaperOrderTicketWeb({
    super.key,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: OrderTicketProductTile(
                          title: 'Trading',
                          subtitle: 'Intraday',
                          selected: c.productMode == 'Trading',
                          onTap: () => c.setProductMode('Trading'),
                        ),
                      ),
                      ...
                      Expanded(
                        child: OrderTicketProductTile(
                          title: 'Pay Later',
                          subtitle: 'via MTF',
                          selected: c.productMode == 'MTF',
                          onTap: () => c.setProductMode('MTF'),
                        ),
                      ),
                      const SizedBox(width: 8),
                      Expanded(
                        child: OrderTicketProductTile(
                          title: 'Investing',
                          subtitle: 'Delivery',
                          selected: c.productMode == 'Investing',
                          onTap: () => c.setProductMode('Investing'),
                        ),
                      ),
                    ],
                  ),
                  if (c.productMode == 'MTF') ...[
                    const SizedBox(height: 8),
                    Text(
                        ...
                        Row(
                          children: [
                            for (final t in const [
                              ...
                              if (t.$1 != 'MARKET') const SizedBox(width: 6),
                              Expanded(
