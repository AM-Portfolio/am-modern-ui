...
///       Auth       → https://am-dev.asrax.in/auth
///       User       → https://am-dev.asrax.in/users
///       Trade      → https://am-dev.asrax.in/trade
///       Gmail      → https://am-dev.asrax.in/gmail
///       MarketData → https://am-dev.asrax.in/market
class ConfigService {
  ...
  static AppConfig get config {
    if (_config == null) {
      ...
      return AppConfig(
        ...
        api: ApiConfig(
          baseUrl: 'https://am-dev.asrax.in/analysis',
          timeout: 30000,
          useMockData: false,
          auth: const AuthApiConfig(
            baseUrl: 'https://am-dev.asrax.in/auth',
          ...
          user: const UserApiConfig(
            baseUrl: 'https://am-dev.asrax.in/users',
          ...
          portfolio: const PortfolioApiConfig(
            baseUrl: 'https://am-dev.asrax.in/portfolio',
          ...
          trade: const TradeApiConfig(
            baseUrl: 'https://am-dev.asrax.in/trade',
  ...
  static Future<void> initialize() async {
    ...
    _config = AppConfig(
      ...
      api: ApiConfig(
        ...
        baseUrl: const String.fromEnvironment('AM_API_BASE_URL', defaultValue: 'https://am-dev.asrax.in/analysis'),
        timeout: 30000,
        useMockData: const bool.fromEnvironment('AM_USE_MOCK_DATA', defaultValue: false),

        // ── Auth (PRODUCTION — not running locally) ──
        auth: AuthApiConfig(
          baseUrl: const String.fromEnvironment('AM_AUTH_BASE_URL', defaultValue: 'https://am-dev.asrax.in/auth'),
          loginEndpoint: '/v1/tokens',
          logoutEndpoint: '/v1/auth/logout',
          refreshTokenEndpoint: '/v1/auth/refresh',
          googleLoginEndpoint: '/v1/auth/google/token',
        ...
        user: UserApiConfig(
          baseUrl: const String.fromEnvironment('AM_USER_BASE_URL', defaultValue: 'https://am-dev.asrax.in/users'),
        ...
        trade: TradeApiConfig(
          baseUrl: const String.fromEnvironment('AM_TRADE_BASE_URL', defaultValue: 'https://am-dev.asrax.in/trade'),
          portfolioListResource: '/v1/portfolio-summary/by-owner',
          portfolioSummaryResource: '/v1/portfolio-summary',
          holdingsResource: '/v1/trades/details/portfolio',
          tradeDetailsResource: '/v1/trades/details',
        ...
        gmail: GmailApiConfig(
          baseUrl: const String.fromEnvironment('AM_GMAIL_BASE_URL', defaultValue: 'https://am-dev.asrax.in/gmail'),
        ...
        marketData: MarketDataConfig(
          wsUrl: const String.fromEnvironment('AM_MARKET_WS_URL', defaultValue: 'wss://am-dev.asrax.in/market/ws/market-data-stream'),
          baseUrl: const String.fromEnvironment('AM_MARKET_BASE_URL', defaultValue: 'https://am-dev.asrax.in/market'),
          connectEndpoint: '/v1/market-data/stream/connect',
        ),

        // ── Analysis (PRODUCTION — fallback from localhost) ──
        analysis: AnalysisApiConfig(
          baseUrl: const String.fromEnvironment('AM_ANALYSIS_BASE_URL', defaultValue: 'https://am-dev.asrax.in/analysis'),
        ),
      ),
      environment: Environment.development,
