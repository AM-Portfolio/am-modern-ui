...
set AM_API_BASE_URL=https://am-dev.asrax.in/analysis
set AM_AUTH_BASE_URL=https://am-dev.asrax.in/auth
set AM_USER_BASE_URL=https://am-dev.asrax.in/users
set AM_PORTFOLIO_BASE_URL=https://am-dev.asrax.in/portfolio
set AM_TRADE_BASE_URL=https://am-dev.asrax.in/trade
set AM_MARKET_WS_URL=wss://am-dev.asrax.in/market/ws/market-data-stream
set AM_MARKET_BASE_URL=https://am-dev.asrax.in/market
set AM_ANALYSIS_BASE_URL=https://am-dev.asrax.in/analysis
