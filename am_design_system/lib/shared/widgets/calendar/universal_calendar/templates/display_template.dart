...
class CalendarDisplayTemplate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (customContent != null) {
      CommonLogger.debug('Using custom content (filter template)',
          tag: 'CalendarDisplayTemplate');
      return customContent!;
    }

    // Priority 3: Show placeholder
    CommonLogger.warning('No calendar data available',
        tag: 'CalendarDisplayTemplate');
  ...
  Widget _buildYearCalendar(BuildContext context) {
    CommonLogger.debug('Building year calendar widget',
        tag: 'CalendarDisplayTemplate');
    ...
    return YearCalendarWidget(
      ...
      onYearChanged: (newYear) {
        CommonLogger.info('Year changed to: $newYear',
            tag: 'CalendarDisplayTemplate');
