...
class _UnifiedSidebarScaffoldState extends State<UnifiedSidebarScaffold>
  ...
  void initState() {
    ...
    _widthAnimation =
        Tween<double>(begin: widget.compactWidth, end: widget.fullWidth)
  ...
  Widget _buildBottomNavigationBar(BuildContext context) {
    ...
    return ModuleBottomNavigation(
      items: navItems,
      currentIndex:
          _mobileSelectedIndex < displayItems.length ? _mobileSelectedIndex : 0,
      onTap: (index) {
                  ...
                  child: Material(
                    ...
                    child: Container(
                      ...
                      decoration: AppGlassmorphismV2.gradientBorderCard(
                        borderColors: [
                          _resolvedColor,
                          _resolvedColor.withOpacity(0.3)
                        ],
                        borderRadius: 24,
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      decoration:
                                          AppGlassmorphismV2.iconGlassContainer(
                                        color: _resolvedColor,
                                        size: 36,
                                        isDark: true,
                                      ),
                                      child: Icon(_resolvedIcon ?? Icons.menu,
                                          color: _resolvedColor, size: 20),
                                    ),
