...
/// CTA opens the upload / doc-intel flow — it does not dismiss the demo.
class DemoPortfolioBanner extends StatelessWidget {
  const DemoPortfolioBanner({
    super.key,
  ...
  /// Outer spacing; use zero horizontal inset when the parent already pads.
