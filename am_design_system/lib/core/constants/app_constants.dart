...
class AppConstants {
  ...
  /// API Configuration
  static const String defaultBaseUrl = 'https://am-dev.asrax.in/portfolio';
  static const int defaultTimeout = 30000;
  static const bool defaultUseMockData = true;

  /// Portfolio API Defaults
  static const String defaultPortfolioBaseUrl = 'https://am-dev.asrax.in/portfolio';
  ...
  /// Trade API Defaults
  static const String defaultTradeBaseUrl = 'https://am-dev.asrax.in/trades';
  ...
  static const String defaultDocumentBaseUrl = 'https://am-dev.asrax.in/documents';
  ...
  /// Auth API Defaults
  static const String defaultAuthBaseUrl = 'https://am-dev.asrax.in/auth/token/v1';
  ...
  /// User API Defaults
  static const String defaultUserBaseUrl = 'https://am-dev.asrax.in/users/account/v1';
