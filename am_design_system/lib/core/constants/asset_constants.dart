...
class AssetPaths {
  ...
  static const String applicationProperties =
      '$assetsRoot/application.properties';
  static const String applicationDevProperties =
      '$assetsRoot/application-dev.properties';
  static const String applicationProdProperties =
      '$assetsRoot/application-prod.properties';
  static const String applicationTestProperties =
      '$assetsRoot/application-test.properties';
  static const String applicationStagingProperties =
      '$assetsRoot/application-staging.properties';
  ...
  static const String mockPortfolioSummary =
      '$assetsRoot/mock_data/portfolio_summary.json';
  static const String mockPortfolioHoldings =
      '$assetsRoot/mock_data/portfolio_holdings.json';
