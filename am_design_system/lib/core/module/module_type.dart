...
enum ModuleType { dashboard, market, trade, portfolio, news, admin, other }
...
extension ModuleTypeExtension on ModuleType {
  ...
  String get subtitle {
    switch (this) {
      case ModuleType.dashboard:
        return 'Overview';
      case ModuleType.market:
        return 'Real-time market insights';
      case ModuleType.trade:
        return 'Trade execution & analysis';
      case ModuleType.portfolio:
  ...
  Color get accentColor {
    switch (this) {
      ...
      case ModuleType.news:
        return ModuleColors.reports; // Reuse Amber
      case ModuleType.admin:
