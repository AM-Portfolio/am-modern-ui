...
class _AppShellState extends State<AppShell> {
  ...
  Widget _buildPage(String userId, bool isDesktop) {
    switch (_selectedIndex) {
      ...
      case 5:
        return const Center(child: Text('Diagnostic (Coming Soon)'));
      case 6:
        return const Center(child: Text('Analysis (Coming Soon)'));
      case 7:
        return const Center(child: Text('Doc Intelligence (Coming Soon)'));
      case 8:
