...
import 'package:market_data_web/screens/market_analytics_page.dart';
import 'package:market_data_web/widgets/constituents_table.dart';
import 'package:market_data_web/widgets/heatmap_view.dart';
...
class _MarketIndexDetailViewState extends State<MarketIndexDetailView> {
  ...
  Widget _buildContent() {
    ...
    if (widget.provider.error != null) {
      return Center(
        child: Text('Error: ${widget.provider.error}', style: const TextStyle(color: Colors.redAccent)),
      );
    }
    ...
    switch (_viewMode) {
      ...
      case 2: return MarketAnalyticsPage(indexSymbol: _getValidIndexSymbol(widget.indexSymbol));
