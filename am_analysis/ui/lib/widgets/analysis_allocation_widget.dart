...
class AnalysisAllocationWidget extends StatefulWidget {
  ...
  @override
  State<AnalysisAllocationWidget> createState() =>
      _AnalysisAllocationWidgetState();
}
      ...
      builder: (context, constraints) {
        ...
        final height = widget.height ??
            (isMobile
                ...
                : isTablet
                    ? 480
                    : 450); // Increased height for selector and badges
                  ...
                  child: Tooltip(
                    ...
                    child: Container(
                      color: color.withValues(
                          alpha: _hoveredIndex == index ? 1.0 : 0.9),
                      child: Center(
                        child: showLabel
                            ? Text(
