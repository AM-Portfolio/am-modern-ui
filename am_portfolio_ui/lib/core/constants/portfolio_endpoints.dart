...
class PortfolioEndpoints {
  ...
  static String get baseUrl =>
      common.ConfigService.config.api.portfolio.baseUrl;

  // Resources - Loaded from ConfigService
  static String get list => '/v1/portfolios/list';
  static String get holdings =>
      common.ConfigService.config.api.portfolio.holdingsResource;
  static String get summary =>
      common.ConfigService.config.api.portfolio.summaryResource;
  static String get transactions =>
      common.ConfigService.config.api.portfolio.transactionsResource;
