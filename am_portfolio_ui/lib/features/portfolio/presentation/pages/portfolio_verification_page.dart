...
class PortfolioVerificationPage extends StatefulWidget {
  ...
  @override
  State<PortfolioVerificationPage> createState() => _PortfolioVerificationPageState();
}
        ...
        children: [
          ...
          StreamBuilder<StompStatus>(
            ...
            builder: (context, snapshot) {
              ...
              Color color;
              switch (status) {
                case StompStatus.connected: color = Colors.green; break;
                case StompStatus.connecting: color = Colors.orange; break;
                case StompStatus.error: color = Colors.red; break;
