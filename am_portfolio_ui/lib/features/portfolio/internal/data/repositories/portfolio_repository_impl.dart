...
class PortfolioRepositoryImpl implements PortfolioRepository {
  ...
  Future<PortfolioItem> createPortfolio(PortfolioCreateRequestDto request) async {
    ...
    try {
      ...
      final item = PortfolioItem(portfolioId: dto.portfolioId, portfolioName: dto.portfolioName);
      return item;
    } catch (e) {
      CommonLogger.error('Failed to create portfolio', tag: 'PortfolioRepository', error: e);
      rethrow;
    }
  }
  ...
  Future<PortfolioItem> updatePortfolio(String portfolioId, PortfolioUpdateRequestDto request) async {
    ...
    try {
      ...
      CommonLogger.error('Failed to update portfolio', tag: 'PortfolioRepository', error: e);
      rethrow;
    }
  }
  ...
  Future<void> deletePortfolio(String portfolioId, {bool deleteTrades = false}) async {
    ...
    try {
      await _remoteDataSource.deletePortfolio(portfolioId, deleteTrades: deleteTrades);
    } catch (e) {
      CommonLogger.error('Failed to delete portfolio', tag: 'PortfolioRepository', error: e);
      rethrow;
    }
  }
