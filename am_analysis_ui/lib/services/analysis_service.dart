...
abstract class AnalysisService {
  Future<List<AllocationItem>> getAllocation(String? id, AnalysisEntityType type);
  Future<List<PerformanceDataPoint>> getPerformance(String? id, AnalysisEntityType type, String timeFrame);
  Future<List<MoverItem>> getTopMovers({String? id, AnalysisEntityType? type});
}

class MockAnalysisService implements AnalysisService {
  @override
  Future<List<AllocationItem>> getAllocation(String? id, AnalysisEntityType type) async {
  ...
  @override
  Future<List<PerformanceDataPoint>> getPerformance(String? id, AnalysisEntityType type, String timeFrame) async {
  ...
  @override
  Future<List<MoverItem>> getTopMovers({String? id, AnalysisEntityType? type}) async {
